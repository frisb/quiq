...
function create(options) {
    ...
    if (!options.middlewares)
        options.middlewares = [];
    options.middlewares.unshift([
        _1_morgan_1.Morgan,
        _2_useragent_1.UserAgent,
        _3_secure_1.Secure,
        _4_servefavicon_1.ServeFavicon,
        _5_compression_1.Compression,
        _6_channel_1.Channel,
        _1_staticclient_1.StaticClient,
        _2_staticpublic_1.StaticPublic,
        _3_errorhandler_1.ErrorHandler,
        _4_final_1.Final
    ]);
