...
const logger = new writeln_1.Logger('WebSocket Server');
class AbstractServer {
    constructor(options) {
        this.tokenizer = null;
        const wsServer = new ws_1.default.Server(Object.assign(options, { verifyClient: options.verifyClient || this.verifyClient.bind(this) }));
    ...
    async verifyClient(info, callback) {
        ...
        let ipv4 = (0, ipaddr_js_1.process)(remoteAddress).toString();
