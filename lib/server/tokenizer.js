...
const logger = new writeln_1.Logger('Tokenizer');
...
class Tokenizer {
    ...
    wrap(remoteIP, channelOrigin, data, include) {
        ...
        let accessToken = (0, jsonwebtoken_1.sign)(data, secret, options);
        let wrappedToken = {
    ...
    async unwrap(remoteIP, channelOrigin, token) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            (0, jsonwebtoken_1.verify)(token, secret, options, function (err, data) {
                if (err) {
