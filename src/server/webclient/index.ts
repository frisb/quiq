...
import { urlParser, WebClientFactory, IRequestOptions, IRequestHeaders, IResponse, IWrappedToken } from '../../common';
...
function request({ url, method, headers, body }: IRequestOptions): Promise<IResponse<string>> {
